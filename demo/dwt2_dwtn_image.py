...
# Now reconstruct and plot the original image
# FIXME: the `take` parameter now needs to be specified explicitly, this should
# not be necessary.  See pywt/src/common.c for determining buffer lengths
reconstructed = pywt.idwtn(coeffsn, 'bior1.3', take=512)
fig = plt.figure()
plt.imshow(reconstructed, interpolation="nearest", cmap=plt.cm.gray)
